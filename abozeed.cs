...
namespace Abozeed{
    ...
    public class Staff : Person{
        ...
        public override void print()
        {
        Console.WriteLine("My Name = "+ Name+ ",My Age = "+Age+", and My Salary = "+Salary );
        }
    }
        ...
        public void AddStudent(Student student){
            ...
            People[CountIndex++]= student; 

           //first element in array  will take value from object student 

        }
        public void AddStaff(Staff staff){

            People[CountIndex++]= staff; 
           
            //first element in array  will take value from object staff
